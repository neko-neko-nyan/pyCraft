...
from minecraft.networking.types import (
    ...
    Enum, Vector, Direction, PositionAndLook, multi_attribute_alias
)
from minecraft.networking.types.utility import LookAndDirection, PositionLookAndDirection
...
class SpawnMobPacket(Packet):
    ...
    def write_fields(self, packet_buffer):
        ...
        if self.context.protocol_version >= 69:
            UUID.send(self.entity_uuid, packet_buffer)
    ...
    # Access the 'yaw', 'pitch' 'head_pitch' fields as a LookAndDirection.
